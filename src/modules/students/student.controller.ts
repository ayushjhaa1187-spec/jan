...
export const createStudent = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const data = await studentService.createStudent(payload, getUserId(req), getIp(req));
...
export const deleteStudent = async (req: Request, res: Response, next: NextFunction) => {
  try {
    await studentService.deleteStudent(String(req.params.id), getUserId(req), getIp(req));
...
export const transferStudentClass = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const data = await studentService.transferClass(
      String(req.params.id),
      payload.classId,
      getUserId(req),
      getIp(req),
