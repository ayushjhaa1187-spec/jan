...
export const createTeacherSubject = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const data = await teacherSubjectService.createAssignment(payload);
...
export const getTeacherSubjectById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const data = await teacherSubjectService.getAssignmentById(String(req.params.id));
    return res.json(success(data));
  } catch (error) {
    return next(error);
  }
...
export const deleteTeacherSubject = async (req: Request, res: Response, next: NextFunction) => {
  try {
    await teacherSubjectService.deleteAssignment(String(req.params.id));
...
export const getTeacherSubjectsByClass = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const data = await teacherSubjectService.getAssignmentsByClass(String(req.params.classId));
    return res.json(success(data));
  } catch (error) {
    return next(error);
  }
...
export const getTeacherSubjectsByTeacher = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const data = await teacherSubjectService.getAssignmentsByTeacher(String(req.params.teacherId));
    return res.json(success(data));
  } catch (error) {
    return next(error);
  }
