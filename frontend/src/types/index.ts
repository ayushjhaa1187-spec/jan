...
export interface Student { id: string; adm_no: string; name: string; email?: string; phone?: string; classId: string; class?: ClassType }
export interface ClassType { id: string; name: string; section: string; year: number; _count?: { students: number } }
...
export interface Exam { id: string; name: string; classId: string; class?: ClassType; startDate: string; endDate: string; status: ExamStatus; creator?: { id: string; name: string }; approver?: { name: string }; publisher?: { name: string } }
