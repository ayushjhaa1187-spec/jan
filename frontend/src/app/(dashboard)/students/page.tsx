...
export default function StudentsPage() {
  ...
  return <div className='space-y-4'><div className='flex justify-between'><h1 className='text-2xl font-bold'>Students</h1><Link href='/students/new' className='bg-[#2b6cb0] text-white px-3 py-2 rounded'>Add</Link></div><Input placeholder='Search students' />
