...
export default function ReportsPage() { return <div className='grid md:grid-cols-2 gap-4'>
<GradeDistributionChart /><SubjectAveragesChart /><PassFailChart /><TopPerformersChart /></div> }
